 ...
 *
 */
public class AdapterError extends Error {
	 ...
	 */
	public AdapterError(String message, Object ... replacements) {
	 ...
	 */
	public AdapterError(Throwable cause) {
		super(cause);
	}
	/**
	 ...
	 * @param replacements The objects to convert to strings to replace instances of '{}' in the message
	 */
	public AdapterError(String message, Throwable cause, Object ... replacements) {
	 ...
	 * @param replacements The objects to convert to strings to replace instances of '{}' in the message
	 */
	public AdapterError(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace, Object ... replacements) {
